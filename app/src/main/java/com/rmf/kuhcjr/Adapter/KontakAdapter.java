...
public class KontakAdapter extends RecyclerView.Adapter<KontakAdapter.MyViewHolder>{
    List<DataKontak> mKontakList;

    public KontakAdapter(List <DataKontak> KontakList) {
        mKontakList = KontakList;
    }

    @Override
    public MyViewHolder onCreateViewHolder (ViewGroup parent, int viewType){
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_kontak, parent, false);

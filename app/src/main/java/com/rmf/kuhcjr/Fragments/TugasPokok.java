...
public class TugasPokok extends Fragment {
    ...
    private AdapterRVDataTugas adapterRVDataTugas;
    ...
    public int tahun_id;
    public String dariActivity="tugas_pokok";
...
//        loadData(view);
    ...
    private void loadData(final View view){
        ...
        Call<GetTugas> TugasPokokCall = mApiInterface.getTugas("ambilTugasPokok",username,tahun_id);
...
//                Collections.reverse(KegiatanList);
                        ...
                        adapterRVDataTugas = new AdapterRVDataTugas(list,TugasPokok.this);

...
public class DataLembur {
    ...
    public DataLembur(int id, String username, String nama, String nik, String jabatan, String file_pengajuan, String uraian, String tanggal, String mulai, String selesai, String disetujui, String tanggal_surat, String file, String nomor_surat, int status, String keterangan, String date_added, String date_updated) {
        this.id = id;
